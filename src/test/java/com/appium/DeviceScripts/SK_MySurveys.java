...
import com.appium.bussinessLogic.SK_MySurveysBL;
...
public class SK_MySurveys extends Base{
	...
	SK_MySurveysBL surveysbl=PageFactory.initElements(driver, SK_MySurveysBL.class);
