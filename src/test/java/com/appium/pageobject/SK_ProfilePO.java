...
public class SK_ProfilePO extends Base {
	...
	public WebElement txtWeight() {
		...
		By Weight = By.id("com.safety.armourgrid:id/register_edit_weight");
		return driver.findElement(Weight);
	}

	public WebElement txtHeight() {

		By Height = By.id("com.safety.armourgrid:id/register_edit_height");
		return driver.findElement(Height);
	}

	public WebElement txtHairColor() {

		By HairColor = By.id("com.safety.armourgrid:id/register_edit_hair");
		return driver.findElement(HairColor);
	}

	public WebElement txtEyeColor() {

		By EyeColor = By.id("com.safety.armourgrid:id/register_edit_eyes");
		return driver.findElement(EyeColor);
	}

	public WebElement txtAddress() {

		By Address = By.id("com.safety.armourgrid:id/register_edit_address");
		return driver.findElement(Address);
	}

	public WebElement txtCity() {

		By City = By.id("com.safety.armourgrid:id/register_edit_city");
		return driver.findElement(City);
	}

	public WebElement txtState() {

		By State = By.id("com.safety.armourgrid:id/register_edit_state");
		return driver.findElement(State);
	}

	public WebElement txtZip() {

		By State = By.id("com.safety.armourgrid:id/register_edit_zip");
		return driver.findElement(State);
	}

	public WebElement txtCountry() {

		By Country = By.id("com.safety.armourgrid:id/register_edit_country");
		return driver.findElement(Country);
	}

	public WebElement txtAutoMake() {

		By AutoMake = By.id("com.safety.armourgrid:id/register_edit_autoMake");
		return driver.findElement(AutoMake);
	}

	public WebElement txtAutoModel() {

		By AutoModel = By.id("com.safety.armourgrid:id/register_edit_autoModel");
		return driver.findElement(AutoModel);
	}

	public WebElement txtAutoColor() {

		By AutoColor = By.id("com.safety.armourgrid:id/register_edit_autoColor");
		return driver.findElement(AutoColor);
	}

	public WebElement txtAutoYear() {

		By AutoYear = By.id("com.safety.armourgrid:id/register_edit_autoYear");
		return driver.findElement(AutoYear);
	}

	public WebElement txtAutoLicence() {

		By AutoLicence = By.id("com.safety.armourgrid:id/register_edit_autoLicense");
		return driver.findElement(AutoLicence);
	}

	public WebElement txtAutoLicenceState() {

		By AutoLicenceState = By.id("com.safety.armourgrid:id/register_edit_autoLicenseState");
		return driver.findElement(AutoLicenceState);
	}

	public WebElement txtMedicAlertInfo() {

		By MedicAlertInfo = By.id("com.safety.armourgrid:id/register_edit_medicAlertInfo");
